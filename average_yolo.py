...
fold_files = [
    f"result_combined_kaggletest_real_fold1.csv",
    f"result_combined_kaggletest_real_fold2.csv",
    f"result_combined_kaggletest_real_fold3.csv",
    f"result_combined_kaggletest_real_fold4.csv",
    f"result_combined_kaggletest_real_fold5.csv"
]
...
output_dir = Path("result/combined_kaggle")
output_file =  output_dir/f'average_yolov8s_combined_kagglex.csv'
